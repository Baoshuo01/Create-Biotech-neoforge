...
- 上游完整版权与许可证原文保留在 [LICENSE.md](LICENSE.md) 中，上游完整第三方声明保留在 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) 中。
- 所有上游代码、文档、资源、名称及其他内容均归各自权利人所有，并继续适用其上游许可证和授权条件。
- Baoshuo01 仅对本人专门为 NeoForge 1.21.1 移植而原创、可分离且具有版权性的代码，在本人拥有且有权授权的范围内声明权利并采用 MIT 许可证。
- Baoshuo01 不对任何上游内容，以及仅对上游内容进行移动、重命名、格式转换、重新排版、机械性适配或其他派生性修改的部分主张所有权。
- 移植附录不替代、不缩减、不重新许可，也不凌驾于任何上游版权声明、许可证、授权或第三方条款之上。

本仓库并非整体适用一份统一许可证。重新分发源码、二进制文件或资源前，请阅读 [LICENSE.md](LICENSE.md)、[THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) 和 [docs/PERMISSIONS.zh-CN.md](docs/PERMISSIONS.zh-CN.md)。

## 致谢

- **Nobodiiiii** — Create: Biotech 原作者及原项目资源权利人。
- **Baoshuo01** — Minecraft 1.21.1 NeoForge 移植与维护。
- **SylviaX-390** — 其上游 CreateButterCat 版权及 MIT 声明保留在法律文件中；本移植不分发相关玩法内容。
