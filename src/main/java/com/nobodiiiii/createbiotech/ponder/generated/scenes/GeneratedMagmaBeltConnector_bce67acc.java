...
public final class GeneratedMagmaBeltConnector_bce67acc {
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:magma_belt", Map.ofEntries(Map.entry("casing", "false"), Map.entry("waterlogged", "false"), Map.entry("part", "start"), Map.entry("facing", "west"), Map.entry("slope", "horizontal")), new BlockPos(3, 1, 2), null, "{Casing:\"NONE\",Controller:{X:-20,Y:-59,Z:7},Covered:0b,Index:0,Inventory:{Items:[],PositiveOrder:1b},IsController:1b,Length:3,Network:{Capacity:262144.0f,Id:-6047313903676L,Size:10,Stress:32.0f},Source:{X:-21,Y:-59,Z:7},Speed:16.0f}", true, null, "none", null, null, null, null, null);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:magma_belt", Map.ofEntries(Map.entry("casing", "false"), Map.entry("waterlogged", "false"), Map.entry("part", "middle"), Map.entry("facing", "west"), Map.entry("slope", "horizontal")), new BlockPos(2, 1, 2), null, "{Casing:\"NONE\",Controller:{X:-20,Y:-59,Z:7},Covered:0b,Index:1,IsController:0b,Length:3,Network:{Capacity:262144.0f,Id:-6047313903676L,Size:9,Stress:32.0f},Source:{X:-22,Y:-59,Z:7},Speed:16.0f}", true, null, "none", null, null, null, null, null);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:magma_belt", Map.ofEntries(Map.entry("casing", "false"), Map.entry("waterlogged", "false"), Map.entry("part", "end"), Map.entry("facing", "west"), Map.entry("slope", "horizontal")), new BlockPos(1, 1, 2), null, "{Casing:\"NONE\",Controller:{X:-20,Y:-59,Z:7},Covered:0b,Index:2,IsController:0b,Length:3,Network:{Capacity:262144.0f,Id:-6047313903676L,Size:8,Stress:32.0f},Source:{X:-22,Y:-59,Z:8},Speed:16.0f}", true, null, "none", null, null, null, null, null);
        scene.addKeyframe();
