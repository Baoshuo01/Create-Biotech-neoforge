...
public final class GeneratedCreeperBlastChamber_685cd207 {
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.createEntity(scene, "minecraft:creeper", new Vec3(4.5, 2.0, 3.5), null, null, null, "{AbsorptionAmount:0.0f,ArmorDropChances:[0.085f,0.085f,0.085f,0.085f],ArmorItems:[{},{},{},{}],Attributes:[{Base:0.25d,Name:\"minecraft:generic.movement_speed\"}],Brain:{memories:{}},CanPickUpLoot:0b,CanUpdate:1b,ExplosionRadius:3b,FallFlying:0b,Fuse:30s,HandDropChances:[0.085f,0.085f],HandItems:[{},{}],Health:20.0f,HurtByTimestamp:0,Invulnerable:0b,LeftHanded:0b,PersistenceRequired:0b,ignited:0b}");
    ...
    private static void storyboard$1(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(40);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:explosion_proof_item_vault", Map.ofEntries(Map.entry("large", "false"), Map.entry("axis", "x")), new BlockPos(2, 2, 3), new BlockPos(2, 3, 4), "{BlastChamberController:-11819750039612L,BlastChamberRole:1,Controller:{X:-44,Y:-59,Z:-10},Inventory:{Items:[],Size:20},LastKnownPos:{X:-44,Y:-58,Z:-9},ScrollValue:1,StorageType:\"CombinedInv\"}", true, null, "none", null, null, null, null, null);
        scene.idle(90);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "结构成型以后，顶面的棱会被自动替换为链式传动箱", new Vec3(3.5, 4.5, 2.0), 120, null, true);
        GeneratedPonderSupport.setBlock(scene, context, "create_biotech:blast_proof_chain_drive", Map.ofEntries(Map.entry("part", "middle"), Map.entry("axis", "z"), Map.entry("axis_along_first", "true")), new BlockPos(5, 4, 2), new BlockPos(3, 4, 2), "{Speed:0.0f}", true, null, "none", null, null, null, null, null);
        scene.idle(130);
        scene.addKeyframe();
    ...
    private static void storyboard$2(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.rotateCameraY(scene, -35.0f, -35.0f, 10);
        GeneratedPonderSupport.modifyBlockEntity(scene, Map.ofEntries(Map.entry("axis", "z"), Map.entry("axis_along_first", "true")), "{Speed:0.0f}", null, new BlockPos(3, 4, 2), new BlockPos(5, 4, 1));
        scene.idle(20);
        scene.addKeyframe();
