...
public final class ExperienceOrbModelRenderer {
	...
	public static void render(PoseStack ms, MultiBufferSource buffer, int packedLight, float ageTicks, int iconValue,
		...
		quad(consumer, pose, -0.5F, -0.25F, red, green, blue, u0, v1, packedLight);
		quad(consumer, pose, 0.5F, -0.25F, red, green, blue, u1, v1, packedLight);
		quad(consumer, pose, 0.5F, 0.75F, red, green, blue, u1, v0, packedLight);
		quad(consumer, pose, -0.5F, 0.75F, red, green, blue, u0, v0, packedLight);
		ms.popPose();
	}

	private static void quad(VertexConsumer consumer, PoseStack.Pose pose, float x, float y, int r, int g,
