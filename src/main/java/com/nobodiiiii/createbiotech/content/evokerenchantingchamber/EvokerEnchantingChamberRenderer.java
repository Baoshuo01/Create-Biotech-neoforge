...
public class EvokerEnchantingChamberRenderer implements BlockEntityRenderer<EvokerEnchantingChamberBlockEntity> {
	...
	@Override
	public AABB getRenderBoundingBox(EvokerEnchantingChamberBlockEntity blockEntity) {
	...
	private void renderEnchantingTable(PoseStack poseStack, MultiBufferSource buffer, int packedLight,
		int packedOverlay) {
		poseStack.pushPose();
		blockRenderer.renderSingleBlock(enchantingTableState, poseStack, buffer, packedLight, packedOverlay, ModelData.EMPTY, null);
		poseStack.popPose();
	}
