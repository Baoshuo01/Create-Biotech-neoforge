...
public final class SlimeMimicHandler {
	...
	private static final ResourceKey<LootTable> VANILLA_SLIME_LOOT_TABLE = ResourceKey.create(
		Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath("minecraft", "entities/slime"));
	...
	public static CompoundTag createPreparedSpawnEggTag(ItemStack stack) {
		...
		return createPreparedEntityTag(entityData == null ? null : entityData.copyTag());
	}
